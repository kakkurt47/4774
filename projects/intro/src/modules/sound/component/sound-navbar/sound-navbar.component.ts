...
@Component({
  selector: 'app-sound-navbar',
  templateUrl: './sound-navbar.component.html',
  styleUrls: ['./sound-navbar.component.scss']
})
export class SoundNavbarComponent extends BaseComponent {
  @Input()
  stickOnTop = false;
