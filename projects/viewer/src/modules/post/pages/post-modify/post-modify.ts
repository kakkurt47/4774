...
@Component({
  selector: 'app-post-video-modify',
  templateUrl: './video/post-video-modify.component.html',
  styleUrls: ['./post-modify.scss', './video/post-video-modify.component.scss']
})
export class PostVideoModifyComponent {
