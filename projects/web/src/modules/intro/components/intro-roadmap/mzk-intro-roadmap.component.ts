...
export class MzkIntroRoadmapComponent extends BaseComponent implements AfterViewInit {
  ...
  timelineList: {
  ...
  }[] = [
    {
      ...
      subtitle: 'Muzika conceptualised',
    ...
    },
    {
      ...
      subtitle: 'Commencement of platform modeling <BR />Establishment of 3 distinct models for token economy of music',
      description: 'Hello World',
      selected: false
    },
    {
      ...
      subtitle: 'Open platform testing of MZK <BR />Closed platform testing of MZK',
      description: 'Hello World',
      selected: false
    },
    {
      date: '09/01/2017',
      topic: 'Q2-Q3, 2018',
      topicTitle: 'TOKEN GENERATION',
      title: 'Token generation',
      subtitle: 'Pre-sales(1,2,3) & Lists Up',
      description: 'Hello World',
      selected: true,
      current: true
    },
    {
      ...
      title: 'Launching',
      subtitle: 'MUZIKA ecosystem prototype',
      description: 'Hello World',
      selected: false
    },
    {
      ...
      title: 'Reshaping global music industry',
      subtitle: 'MUZIKA Beta & Official Global Launch',
      description: 'Hello World',
      selected: false
    }
  ];
